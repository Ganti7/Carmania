...
?>
		...
		<?php // script pour filtrer les véhicules et les afficher
			...
			$requete="SELECT SQL_CALC_FOUND_ROWS * FROM vehicule_location WHERE 1=1";
	...
	<script type="text/javascript" src="http://code.jquery.com/jquery-1.7.2.min.js"></script>
		...
		function rec(p)  // fonction de filtrage
			{
				var url="carmania_recherche_l.php?page="+p+"&marque=<?php$_GET['marque']?>&transmission=<?php$_GET['transmission']?>&prix=<?php$_GET['prix']?>";
